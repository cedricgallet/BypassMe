            ...
            <div class="card" style="width: 20rem; height:31rem;">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item text-info">Pseudo: <?=$_SESSION['user']['pseudo'] ?></li>
                        <li class="list-group-item text-info">Email: <?=$_SESSION['user']['email'] ?></li>
                        <li class="list-group-item text-info pb-0 pt-0">IP: <?=$_SESSION['user']['ip'] ?></li>
                    </ul>   
                </div>
            </div>
        </div>        
