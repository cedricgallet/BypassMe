    ...
    <div class="container">
        <div class="col-md-12">    
            <div class="text-center">
                ...
                <hr />
                <a href="/../controllers/logout-ctrl.php" class="btn btn-danger btn-lg">Déconnexion</a>
                <!-- Boutton modal -->
                <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#change_password">
                    Changer mon mot de passe
                </button><button type="button" class="btn btn-info btn-lg ml-1" data-toggle="modal" data-target="#avatar">
                    Changer mon avatar
                </button>
                <a href="/../views/home.php" class="btn btn-danger btn-lg">Accueil</a>
            </div>
        </div>
    </div>
