...
<main class="mb-3">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="mt-3 col-lg-10 col-md-12 col-sm-12">
                ...
                <nav class="mt-3" aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item"><a class="page-link" href="/views/templates/faille-applicative.php">1</a>
                        </li>
                        <li class="page-item"><a class="page-link" href="/views/templates/faille-humaine.php">2</a></li>
            ...
            <div class="mt-3 col-lg-2 col-md-12 col-sm-12">
