...
<div class="card bg-light shadow bg-body rounded-3 mb-2">
    <div class="card-body">
        ...
        <p class="card-text">
            ...
            Pour l'anecdote, l'abréviation aurait dû être logiquement CSS mais comme ce terme était déjà employé pour
            désigner les feuilles de styles (Cascading Style Sheets en anglais), le X fut choisi en raison du premier
            mot (cross ou croix en français).
