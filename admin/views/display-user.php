          ...
          <div class="text-center">
              <div class="d-flex justify-content-start mt-3 ms-3">
                  ...
                  ?>
                          ...
                          <div class='card-text text-info text-start me-1'>Status de l'utilisateur > <strong class="text-danger">DÉSACTIVÉ</strong>
                          </div>

                  <?php } else { ?>

                          <div class='card-text text-info text-start me-1'>Status de l'utilisateur > <strong class="text-success">ACTIVÉ</strong>
                          </div>
