            ...
            <table class="table table-hover table-responsive table-bordered">
                ...
                <tbody>
                    ...
                    <tr class="text-white fs-3">
                        ...
                        <td>
                            <a href="/../../admin/controllers/display-article-ctrl.php?id=<?=htmlentities($getArticle->id)?>"><i
                                    class="text-info far fa-edit"></i></a>
                            <a href="/../../admin/controllers/delete-article-ctrl.php?id=<?=htmlentities($getArticle->id)?>"
                                onclick="return confirmDeleteArticle();"><i
